...
def get_checkout_data():
	...
	data = [ {u'primaryCreator': {u'role': u'Author', u'name': u'Wilkie Collins'},
			  ...
			  u'synopsis': u'The Woman in White is credited with being the first of the sensation novels, and one of the finest examples of the genre. A young woman\'s husband defrauds her of her fortune, her identity and eventually her sanity. She is saved by her sister and a loyal man who loves her, and her two rescuers attempt to expose her husband. They meet a woman dressed all in white whose fate seems curiously intertwined with that of the young woman. In the tradition of the sensation novel, the story contravenes boundaries of class, identity and the private and public spheres.',
			 ...
			 {u'primaryCreator': {u'role': u'Author', u'name': u'Sandra Brown'}, 
			  ...
			  u'synopsis': u'On a rainy Southern night, Jade Sperry endured a young woman\'s worst nightmare at the hands of three local hell-raisers. Robbed of her youthful ideals and at the center of scandal and tragedy, Jade ran as far and as fast as she could. But she never forgot the sleepy "company town" where every man, woman, and child was dependent on one wealthy family. And she never forgot their spoiled son, who, with his two friends, changed her life forever. Someday, somehow, she would return, exact a just revenge and free herself from fear, and the powerful family that could destroy her.',
			  ...
			  {u'primaryCreator': {u'role': u'Author', u'name': u'Zane Grey'}, 
			   ...
			   u'synopsis': u'The inspiration for several Western movies, Zane Grey\'s The Border Legion tells the tale of hardened gunslinger Jack Kells, who finds his gruff facade melting when he encounters Joan Randle, a spunky heroine who has been captured by a militia stationed near the Idaho border.',
			  ...
			  {u'primaryCreator': {u'role': u'Author', u'name': u'John Grisham'}, 
			   ...
			   u'synopsis': u'The partners at Finley & Figg often refer to themselves as a "boutique law firm." Boutique, as in chic, selective, and prosperous. Oscar Finley and Wally Figg are none of these things. They are a two-bit operation of ambulance chasers who bicker like an old married couple. Until change comes their way--or, more accurately, stumbles in. After leaving a fast-track career and going on a serious bender, David Zinc is sober, unemployed, and desperate enough to take a job at Finley & Figg.\nNow the firm is ready to tackle a case that could make the partners rich--without requiring them to actually practice much law. A class action suit has been brought against Varrick Labs, a pharmaceutical giant with annual sales of $25 billion, alleging that Krayoxx, its most popular drug, causes heart attacks. Wally smells money. All Finley & Figg has to do is find a handful of Krayoxx users to join the suit. It almost seems too good to be true . . . and it is.',
			  ...
			  {u'primaryCreator': {u'role': u'Author', u'name': u'Dean Koontz'},
			   ...
			   u'synopsis': u'In Innocence, Dean Koontz blends mystery, suspense, and acute insight into the human soul in a masterfully told tale that will resonate with readers forever.\nHe lives in solitude beneath the city, an exile from society, which will destroy him if he is ever seen.\nShe dwells in seclusion, a fugitive from enemies who will do her harm if she is ever found.\nBut the bond between them runs deeper than the tragedies that have scarred their lives. Something more than chance--and nothing less than destiny--has brought them together in a world whose hour of reckoning is fast approaching.',
	...
	for book_on_check_out in data:
		...
		book_data['synopsis'] = book_on_check_out['synopsis']
...
def get_hold_data():
	...
	data = [ {u'primaryCreator': {u'role': u'Author', u'name': u'Donna Tartt'}, 
			  ...
			  u'synopsis': u'The second novel by Donna Tartt, bestselling author of The Goldfinch (winner of the 2014 Pulitzer Prize), The Little Friend is a grandly ambitious and utterly riveting novel of childhood, innocence and evil. ',
			 ...
			 {u'primaryCreator': {u'role': u'Author', u'name': u'David Remnick'},
			  ...
			  u'synopsis': 'In this nuanced and complex portrait of Barack Obama, Pulitzer Prize-winner David Remnick offers a thorough, intricate, and riveting account of the unique experiences that shaped our nation\'s first African American president.',
			 ...
			 {u'primaryCreator': {u'role': u'Author', u'name': u'Kami Garcia'}, 
			  ...
			  u'synopsis': u'Ethan Wate has spent most of his life longing to escape the stiflingly small Southern town of Gatlin. He never thought he would meet the girl of his dreams, Lena Duchannes, who unveiled a secretive, powerful, and cursed side of Gatlin, hidden in plain sight. And he never could have expected that he would be forced to leave behind everyone and everything he cares about. So when Ethan awakes after the chilling events of the Eighteenth Moon, he has only one goal: to find a way to return to Lena and the ones he loves.\nBack in Gatlin, Lena is making her own bargains for Ethan\'s return, vowing to do whatever it takes -- even if that means trusting old enemies or risking the lives of the family and friends Ethan left to protect.\nWorlds apart, Ethan and Lena must once again work together to rewrite their fate, in this stunning finale to the Beautiful Creatures series.',
	...
	for book_on_hold in data:
		...
		book_data['synopsis'] = book_on_hold['synopsis']
